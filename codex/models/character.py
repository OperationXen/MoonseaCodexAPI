...
class Character(models.Model):
    ...
    vision = models.CharField(
        max_length=128, blank=True, null=True, help_text="Any special vision modes (eg darkvision)"
    )
    ...
    dm_text = models.TextField(
        blank=True,
        null=True,
        verbose_name="DM help text",
        help_text="Any information that may be useful for your DM to know ahead of time",
    )

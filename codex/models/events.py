...
class Game(models.Model):
    ...
    dm = models.ForeignKey(
        ...
        related_name="games",
        help_text="Moonsea Codex DM (optional)",
    )
...
class DMReward(models.Model):
    ...
    dm = models.ForeignKey(
        DungeonMasterInfo, null=True, on_delete=models.CASCADE, related_name="rewards", help_text="Moonsea Codex DM"
    )
    ...
    character_level_assigned = models.ForeignKey(
        Character,
        on_delete=models.SET_NULL,
        null=True,
        blank=True,
        related_name="dm_levels",
        help_text="Character given levels",
    )
    character_items_assigned = models.ForeignKey(
        Character,
        on_delete=models.SET_NULL,
        null=True,
        blank=True,
        related_name="dm_items",
        help_text="Character given item / gold / downtime rewards",
    )
...
class ManualCreation(models.Model):
    ...
    name = models.CharField(
        max_length=128, blank=True, null=True, help_text="Type of manual creation", default="Created by user"
    )
    character = models.ForeignKey(
        Character, on_delete=models.SET_NULL, null=True, blank=True, help_text="Character item was created for"
    )
...
class ManualEdit(models.Model):
    ...
    name = models.CharField(
        max_length=128, blank=True, null=True, help_text="Type of edit undertaken", default="Item name changed"
    )
    item = models.ForeignKey(MagicItem, null=True, on_delete=models.SET_NULL)

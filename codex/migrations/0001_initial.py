    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('portrait', models.ImageField(blank=True, null=True, upload_to='character/artwork')),
                ('token', models.ImageField(blank=True, null=True, upload_to='character/tokens')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('character_items_assigned', models.ForeignKey(help_text='Character given item / gold / downtime rewards', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='dm_items', to='codex.character')),
                ('character_level_assigned', models.ForeignKey(help_text='Character given levels', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='dm_levels', to='codex.character')),
                ('dm', models.ForeignKey(help_text='Moonsea Codex DM', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='dm_rewards', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Consumable',

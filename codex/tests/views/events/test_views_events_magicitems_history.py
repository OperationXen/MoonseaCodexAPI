...
class TestMagicItemHistoryViews(TestCase):
    ...
    fixtures = [
        "test_users",
        "test_dungeonmaster_reward",
        "test_character_games",
        "test_characters",
        "test_magic_items",
        "test_magicitem_trades",
        "test_magicitem_manualcreation",
        "test_magicitem_manualedit",
    ]
    ...
    def test_list_magicitem_history_invalid_uuid(self) -> None:
        ...
        response = self.client.get(
            reverse("magicitem_events", kwargs={"magicitem_uuid": "12345678-1234-1234-1234-12345678abcd"})
        )

...
class CSVImportParserTest(TestCase):
    ...
    def test_parse_classes_single(self):
        test_class_1 = {"class": "Wizard", "subclass": "Abjuration", "value": 10}
        test_class_2 = {"class": "Fighter", "subclass": "", "value": 3}
        test_class_3 = {"class": "Sorcerer", "subclass": "Draconic Red", "value": 15}
    ...
    def test_parse_classes_multiple(self):
        test_class_1 = {"class": "Sorcerer", "subclass": "Wild Magic", "value": 5}
        test_class_2 = {"class": "Paladin", "subclass": "", "value": 1}

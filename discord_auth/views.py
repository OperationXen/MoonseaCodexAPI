            ...
            if code:
                ...
                if user_data:
                    ...
                    if discord_user:
                        ...
                        pass  # User failed authentication
                else:
                    pass  # Unable to exchange supplied code for token
            else:
                pass  # Unable to get code from request
    else:
        pass  # No state in discord return, possible hijack
